...
# Seleccionar un subconjunto de datos de evaluación. Usaremos el tamaño real del dataset si es menor que 100.
eval_size = min(len(train_dataset), 100)  # Seleccionamos hasta 100 ejemplos, pero no más
